...
var accountBalance = depositOfFunds - withdrawalOfFunds - accruedFees; // the account balance can be found when you take the amount from the deposits, subtract the amount from the withdrawals and subtract the amount from the fees. 
